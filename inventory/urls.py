...
from .views import EquipmentListView, EquipmentDetailView, BookingCreateView, MyBookingsListView
...
urlpatterns = [
    ...
    path('equipment/<int:pk>/book/', BookingCreateView.as_view(), name='book_equipment'),
